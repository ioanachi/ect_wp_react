...
export class Timezones extends React.Component {
  ...
  chooseTimezone(timezone,x) {
    const JsonTimezones = {
      ...
      "(GMT+11:00) Moscow+08 - Magadan": "Asia/Magadan",
  ...
  render() {
    return (<div className="componentContainer">
      <TimezonePicker defaultValue="Asia/Yerevan" value={this.state.timezoneC} onChange={this.chooseTimezone} inputProps={{
